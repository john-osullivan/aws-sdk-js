...
declare namespace CognitoIdentityServiceProvider {
  ...
  export interface InitiateAuthSuccessResponse {
    /**
     * The result of the authentication response. This is only returned if the caller does not need to pass another challenge. If the caller does need to pass another challenge before it gets tokens, ChallengeName, ChallengeParameters, and Session are returned.
     */
    AuthenticationResult: AuthenticationResultType;
  }
  export interface InitiateAuthChallengeResponse {
    /**
  ...
  export type InitiateAuthResponse = InitiateAuthSuccessResponse | InitiateAuthChallengeResponse;
